...
public class StationsService {
    ...
    public StationsService(StationRepository stationRepository, WeatherRepository weatherRepository, StationMapper stationMapper, StationListMapper stationListMapper, RedisTemplate<String, Station> stationRedisTemplate, ReactiveValueOperations<String, Station> stationReactiveValueOperations) {
